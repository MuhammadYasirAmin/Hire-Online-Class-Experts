                  ...
                  <div class="row align-items-center">
                     <div class="col-xxl-6 col-xl-8 col-lg-8 col-md-8">
                        <div class="header__info">
                           <ul>
                              <li>
                                 <a href="/cdn-cgi/l/email-protection#4c25222a230c29283927293e622f2321"> 
                                    ...
                                    </svg> <span class="__cf_email__" data-cfemail="b3daddd5dcf3d6d7c6d8d6c19dd0dcde">[email&#160;protected]</span></a>
                              </li>
                              <li>
                     ...
                     <div class="col-xxl-6 col-xl-4 col-lg-4 col-md-4">
                        <div class="header__top-right d-flex justify-content-end align-items-center">
                           <div class="header__btn ml-20">
                              <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#offcanvasmodal" class="header-btn">Apply Now</a>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="container">
                  <div class="row align-items-center">
                     <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-6 col-6">
                        <div class="logo">
                           <a href="https://hireonlineclassexperts.com/">
                     ...
                     <div class="col-xxl-7 col-xl-7 col-lg-8 d-none d-lg-block">
                        <div class="main-menu">
                           <nav id="mobile-menu">
                              <ul>
                                 <li>
                                    <a href="https://hireonlineclassexperts.com/">Home</a>
                                 </li>
                                 <li>
                                    <a href="About-Us.php">About Us</a>
                                 </li>
                                 <li>
                                    <a href="Our-Experts.php">Our Experts</a>
                                 </li>
                                 <li class="has-dropdown">
                                    ...
                                    <ul class="submenu">
                                       ...
                                       <li><a href="We-Provide-Quiz-Help.php">We Provide Quiz Help</a></li>
                                    </ul>
                                 </li>
                                 <li>
                                    <a href="Our-Courses.php">Our Courses</a>
                                 </li>
                                 <li>
                         ...
                         <div class="offcanvas__contact mt-30 mb-20">
                            ...
                            <ul>
                               ...
                               <li class="d-flex align-items-center">
                                  ...
                                  <div class="offcanvas__contact-text">
                                     <a href="/cdn-cgi/l/email-protection#15666065657a6761557278747c793b767a78">088889797697</a>
                                  </div>
                               </li>
                               <li class="d-flex align-items-center">
                                  <div class="offcanvas__contact-icon mr-15">
                                  ...
                                  <div class="offcanvas__contact-text">
                                     <a href="tel:+012-345-6789"><span class="__cf_email__" data-cfemail="c4b7b1b4b4abb6b084a9a5ada8eaa7aba9">[email&#160;protected]</span></a>
                                  </div>
                               </li>
                            </ul>
                         </div>
