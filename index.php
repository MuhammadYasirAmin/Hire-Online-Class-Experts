...
<html class="no-js" lang="zxx">
   <head>
      ...
      <title>Home – Hire Online Class Experts</title>
            ...
            <div class="slider__active swiper-container">
               <div class="swiper-wrapper">
                  <div class="slider__item swiper-slide p-relative slider__height d-flex align-items-center z-index-1">
                     <div class="slider__bg slider__overlay include-bg" data-background="assets/img/slider1.jpg"></div>
                     <div class="container">
                        <div class="row">
                           <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-10 col-sm-10">
                              <div class="slider__content p-relative z-index-1">
                                 ...
                                 <div class="slider__btn" data-animation="fadeInUp" data-delay="1.1s">
                                    <a href="Our-Courses.php" class="tp-btn">Find Courses</a>
                                 </div>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="slider__item swiper-slide p-relative slider__height d-flex align-items-center z-index-1">
                     <div class="slider__bg slider__overlay include-bg" data-background="assets/img/slider2.jpg"></div>
                     <div class="container">
                        <div class="row">
                  ...
                  <div class="row">
                        ...
                        <div class="features__item features__border-right d-sm-flex align-items-start white-bg mb-30">
                           ...
                           <div class="features__content">
                              <h3 class="features__title">
                                 <a href="About-Us.php">Graduation</a>
                              </h3>
                              <p>Euucal University was established it is recognized.</p>

                              <a href="About-Us.php" class="link-btn">Learn More <i class="fa-regular fa-arrow-right"></i></a>
                           </div>
                        </div>
                     </div>
                     <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                        <div class="features__item features__border-right d-sm-flex align-items-start white-bg mb-30">
                           ...
                           <div class="features__content">
                              <h3 class="features__title">
                                 <a href="About-Us.php">University Life</a>
                              </h3>
                              <p>Euucal University was established it is recognized.</p>
                     ...
                     <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                        <div class="features__item d-sm-flex align-items-start white-bg mb-30">
                           ...
                           <div class="features__content">
                              <h3 class="features__title">
                                 <a href="About-Us.php">Education Services</a>
                              </h3>
                              <p>Euucal University was established it is recognized.</p>
                  ...
                  <div class="col-xxl-5 col-xl-5 col-lg-5">
                     <div class="about__content pl-70 pr-25">
                        ...
                        <div class="about__btn">
                           <a href="About-Us.php" class="tp-btn tp-btn-2">Read more</a>
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-6 grid-item">
                     <div class="campus__thumb w-img mb-30">
                         <div class="section__title-wrapper text-center mb-25">
                             <span class="section__title-pre">SignUp & Get 60% Discount</span>
                           <h2 class="section__title section__title-40">Apply Now</h2>
                        </div>
                        <div class="contact__form mb-25">
                            <form method="POST">
                                <div class="col-12 contact__form-input">
                                    <input type="text" name="Lead_Name" placeholder="Full Name" required>
                                </div>
                                <div class="col-12 contact__form-input">
                                    <input type="text" name="Lead_Email" placeholder="Email Address" required>
                                </div>
                                <div class="col-12 contact__form-input">
                                    <input type="text" name="Lead_Phone" placeholder="Phone Number" required>
                                </div>
                                <div class="col-12 contact__form-input">
                                    <input type="text" name="Lead_Subject" placeholder="Subject" required>
                                </div>
                                <div class="col-12 contact__form-input">
                                    <input type="text" name="Lead_Message" placeholder="Message" required>
                                </div>
                                <div class="col-xxl-12">
                                    <div class="contact__btn">
                                       <button type="submit" name="lead_sbmit_btn" class="tp-btn w-100">Get 60% Discount Now</button>
                                    </div>
                                 </div>
                            </form>
                         </div>
                     ...
                     <div class="col-xxl-6 col-xl-6 col-lg-6">
                        <div class="cta__item cta__item-border pt-40 pb-15 d-sm-flex align-items-start pr-110">
                           ...
                           <div class="cta__content">
                              <h3 class="cta__title">Get 60% Discount</h3>
                              <p>Teach what you love. Learned gives you neccessary tools to become an instructor.</p>
                              <a href="Contact-Us.php" class="tp-btn tp-btn-3">Apply Now</a>
                           </div>
                        </div>
                     </div>
                     <div class="col-xxl-6 col-xl-6 col-lg-6">
                        <div class="cta__item pl-85 pt-40 pb-15 d-sm-flex align-items-start">
                           ...
                           <div class="cta__content">
                              <h3 class="cta__title">Apply for Services</h3>
                              <p>Course completed? Then its time apply the certificate Do it in simplesteps with Learned.</p>
                              <a href="Contact-Us.php" class="tp-btn tp-btn-4">Apply Now</a>
                           </div>
                        </div>
                     </div>
                  </div>
